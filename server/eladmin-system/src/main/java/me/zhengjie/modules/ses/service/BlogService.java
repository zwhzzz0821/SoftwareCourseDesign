...
public interface BlogService extends IService<Blog> {
    ...
    * @return PageResult
    */
    PageResult<Blog> queryAll(BlogQueryCriteria criteria, Page<Object> page);
    ...
    * @return List<BlogDto>
    */
    List<Blog> queryAll(BlogQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<Blog> all, HttpServletResponse response) throws IOException;
}
